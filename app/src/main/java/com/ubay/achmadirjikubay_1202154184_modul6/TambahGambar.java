...
public class TambahGambar extends AppCompatActivity {
    ...
    public static final String Database_Path = "UBAY";
            ...
            storageReference2nd.putFile(FilePathUri)
                    .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                        ...
                        public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                            ...
                            FeedData imageUploadInfo = new FeedData(TempImageName, taskSnapshot.getDownloadUrl().toString(), Dashboard.emailUser);
                            ...
                            Intent i = new Intent(TambahGambar.this,Dashboard.class);
                            startActivity(i);
                        }
                    })
