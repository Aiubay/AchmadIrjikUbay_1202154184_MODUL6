...
public class FragmentTab2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
       ...
       // View layout = inflater.inflate(R.layout.feed_item, container, true);
        ...
        databaseReference = FirebaseDatabase.getInstance().getReference("UBAY");

//       user.setText(Dashboard.emailUser);
    //    Toast.makeText(getContext(), Dashboard.emailUser, Toast.LENGTH_LONG).show();
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                for (DataSnapshot postSnapshot : snapshot.getChildren()) {
                    ...
                    String user = Dashboard.emailUser;
                    String data = String.valueOf(feedData.getUserImage());

                    if(data.equals(user)){
                        //Toast.makeText(getContext(), feedData.getUserImage()+" "+Dashboard.emailUser, Toast.LENGTH_LONG).show();
                        list.add(feedData);}
                }
