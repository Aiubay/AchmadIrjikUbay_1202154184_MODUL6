...
public class DetailGambar extends AppCompatActivity {
    ...
    List<komen> komenList = new ArrayList<>(); //inisiasi variable
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        kom = (EditText)findViewById(R.id.komen); //referensi variable


        recyclerView = (RecyclerView) findViewById(R.id.komment); //referensi variable
        ...
        Toast.makeText(DetailGambar.this, Dashboard.emailUser, Toast.LENGTH_SHORT).show(); //referensi variable
        //
        ...
        userKomen = Dashboard.emailUser; //referensi variable
    ...
    public void post(View view) { //onClicked button
        komen k = new komen(userKomen,kom.getText().toString()); //refrensikan variable
        ...
        databaseReference.addValueEventListener(new ValueEventListener() {//eksekusi data dari firebase
            ...
            public void onDataChange(DataSnapshot snapshot) {
                ...
                for (DataSnapshot postSnapshot : snapshot.getChildren()) { //foreach memanggil data
                    ...
                    komen imageUploadInfo = postSnapshot.getValue(komen.class); //get data dari firebase
